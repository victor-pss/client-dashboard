...
const Card: React.FC<{ status: string, title: string, id: string, description: string }> = ({ title, description, status }: any) => {
  ...
  return (
    ...
    // </div>
    <div
      className="relative flex flex-col bg-clip-border rounded-xl bg-gradient-to-br from-[#802BB1] to-[#0024C0] text-white shadow-gray-500 shadow-md w-full max-w-[20rem] p-8 mb-4">
      <div
