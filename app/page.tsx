    ...
    <main>
      <Nav title="PSS Projects" clientId="" projectManager="" >
        ...
        <div className="absolute top-1/3 left-1/3 w-1/3 p-16 bg-gradient-to-b from-[rgba(0,36,192,.199)] to-[#0024c0]">
          ...
          <p className="text-lg text-center mt-5 font-[oswald,sans-serif]">Whoops! If you havve stumbled upon this page, please reach out to your Project Manager for help accessing your project page.</p>
        </div>
      </Nav>
    </main>
  );
